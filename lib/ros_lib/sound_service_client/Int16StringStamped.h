#ifndef _ROS_sound_service_client_Int16StringStamped_h
#define _ROS_sound_service_client_Int16StringStamped_h
...
namespace sound_service_client
{
  ...
  class Int16StringStamped : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "sound_service_client/Int16StringStamped"; };
